...
public:
    ...
    // Shared entry construction for PcView/AppView's SelectAddressDialog. ComputerModel
    // also uses this function so the schema and selected-entry rules remain identical.
    //
    // Keep the AppModel translation context to reuse existing translated strings.
